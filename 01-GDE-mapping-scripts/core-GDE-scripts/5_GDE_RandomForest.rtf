...
Map.addLayer(classification,\{min: 1,max: 2,palette:['green','white']\}, 'GDE classification');\
          \
\
...
\
/////////////////////////////////////////////////////\
// Step 6. Output probability of GDE classification //\
/////////////////////////////////////////////////////\
var classifierprob = ee.Classifier.smileRandomForest(\{\
        ...
        maxNodes:3010,\
        seed:0\})  // random seed for "random" choices like sampling. Setting this allows others to reproduce your exact results even with stocastic parameters\
.setOutputMode("MULTIPROBABILITY").train(training, "class", (["ETaP","CTI","lst_tpi5400","msavi","msavi_cv","ndvi", "ndvi_cv","ndwi_leaf","ndwi_leaf_cv","ndwi_water","ndwi_water_cv"]))\
\
var classificationprob = predictorimage.classify(classifierprob);\
Map.addLayer(classificationprob.arrayGet([0]),\{min: 0,max: 1,palette:['white','green']\}, 'GDE probability');  \
\
//////////////////////////////////////////////////////\
...
\
// Apply the join.\
var jointrain = simpJoin.apply(trainingpoints, training, joinFilter);\
var joinval = simpJoin.apply(trainingpoints, validation, joinFilter);\
\
\
