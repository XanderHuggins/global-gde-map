...
\f0\fs24 \cf0 ////////////////////////////////////////////////////////////////////////////////////////////////////\
// Title: 7_CrossValidation_NewMexico_HyperparameterTuning\
// Authors: Melissa M. Rohde\
// Description: Tune parameters in random forest for New Mexico cross validation test\
...
var numTreesList = ee.List.sequence(10, 80, 10);\
\
...
// --- Number of Trees --- //\
// Tune the numberOfTrees parameter.\
var numTreesList = ee.List.sequence(90, 140, 10);\
\
var accuracies_trees = numTreesList.map(function(t) \{\
  var classifier = ee.Classifier.smileRandomForest(\{\
    numberOfTrees:t\})\
...
var varPerSplitList = ee.List.sequence(1,8,1);\
\
