...
\f0\fs24 \cf0 ////////////////////////////////////////////////////////////////////////////////////////////////////\
// Title: 8_CrossValidation_NewMexico_RandomForest\
...
\
\
// Load training outputs from "6_CrossValidation_NewMexico_TrainingData" script\
var training1 = ee.FeatureCollection('projects/ee-global-gde-map/assets/CrossValidation/trainingpts1_withpredictors_noNewMexico');\
var training2 = ee.FeatureCollection('projects/ee-global-gde-map/assets/CrossValidation/trainingpts2_withpredictors_noNewMexico');\
var training3 = ee.FeatureCollection('projects/ee-global-gde-map/assets/CrossValidation/trainingpts3_withpredictors_noNewMexico');\
var training4 = ee.FeatureCollection('projects/ee-global-gde-map/assets/CrossValidation/trainingpts4_withpredictors_noNewMexico');\
var training5 = ee.FeatureCollection('projects/ee-global-gde-map/assets/CrossValidation/trainingpts5_withpredictors_noNewMexico');\
var training6 = ee.FeatureCollection('projects/ee-global-gde-map/assets/CrossValidation/trainingpts6_withpredictors_noNewMexico');\
var training7 = ee.FeatureCollection('projects/ee-global-gde-map/assets/CrossValidation/trainingpts7_withpredictors_noNewMexico');\
var training8 = ee.FeatureCollection('projects/ee-global-gde-map/assets/CrossValidation/trainingpts8_withpredictors_noNewMexico');\
\
//Merge Training Data\
...
\
\
// Load validation outputs from "6_CrossValidation_NewMexico_TrainingData" script\
var validation1 = ee.FeatureCollection('projects/ee-global-gde-map/assets/CrossValidation/validationpts1_withpredictors_noNewMexico');\
var validation2 = ee.FeatureCollection('projects/ee-global-gde-map/assets/CrossValidation/validationpts2_withpredictors_noNewMexico');\
var validation = validation1.merge(validation2);\
print(validation.size(),'validation size') // Check validation point size\
\
\
// Step 3.2. Extract New Mexico for cross validation\
\
// Load asset from "6_CrossValidation_NewMexico_TrainingData" script\
var trainingpoints = ee.FeatureCollection('projects/ee-global-gde-map/assets/CrossValidation/trainingPts_noNewMexico')\
\
\
// New Mexico data for cross validation\
var CrossVal_NewMexico = ee.FeatureCollection('projects/ee-global-gde-map/assets/CrossValidation/trainingPts_NewMexico')\
print(CrossVal_NewMexico,'CrossVal_NewMexico')\
\
///////////////////////////////////////\
// Step 4. Build Random Forest Model //\
///////////////////////////////////////\
\
// Step 4.1. Train the Classifier using tuned hyperparameters(output from "6_CrossValidation_NewMexico_HyperparameterTuning" script)\
...
\
///////////////////////////////////////////\
// Step 6. Sample New Mexico Data //\
///////////////////////////////////////////\
\
var CrossVal_NewMexico = classification.sampleRegions(\{\
    collection: CrossVal_NewMexico,\
    scale: 30,\
    tileScale: 16\
  \});\
\
Export.table.toDrive(\{\
  collection: CrossVal_NewMexico,\
  description:'CrossVal_NewMexico',\
  fileFormat: 'csv'\
\});\
\
}