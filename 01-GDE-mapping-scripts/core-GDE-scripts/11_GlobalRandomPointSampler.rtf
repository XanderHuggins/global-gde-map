...
\f0\fs24 \cf0 ////////////////////////////////////////////////////////////////////////////////////////////////////\
// Title: 11_GlobalRandomPointSampler\
// Authors: Christine Albano and Melissa M. Rohde\
// Description: Extract predictor values at randomly generated points \
// within the model extent to compare distributions with those of training points in model\
...
\
/////////////////////////////////////////////////////////////////////////\
// Step 3. Extract predictor variable values to global  random points //\
/////////////////////////////////////////////////////////////////////////\
\
\
// Step 3.1. Load Random Global Points (source: "10_GlobalRandomPointGenerator)\
var randomptsN = ee.FeatureCollection("projects/ee-global-gde-map/assets/VariableDistributionPlots/randomGlobalPts_validationN");\
var randomptsS = ee.FeatureCollection("projects/ee-global-gde-map/assets/VariableDistributionPlots/randomGlobalPts_validationS");\
    \
// Merge all training points\
var trainingPtsall = randomptsN.merge(randomptsS);\
  print('RandomPtsSize',trainingPtsall.size()); // Check sample size\
  //print(trainingPts.limit(1000),'trainingPts');\
  Map.addLayer(trainingPtsall,\{\},'trainingPtsall');\
\
// // Step 3.2. Append predictor variables to random points using the sampleRegions function.\
\
...
\
// // Step 3.2.2 Sample pixels at the random points\
\
...
\
/////////////////////////////////////////////////////\
// Step 4. Export the random point data //\
/////////////////////////////////////////////////////\
\
Export.table.toDrive(\{\
  collection: training1,\
  description:'globalvalpts1_withpredictors',\
  fileFormat: 'csv'\
\});\
\
Export.table.toDrive(\{\
  collection: training2,\
  description:'globalvalpts2_withpredictors',\
  fileFormat: 'csv'\
\});\
Export.table.toDrive(\{\
  collection: training3,\
  description:'globalvalpts3_withpredictors',\
  fileFormat: 'csv'\
\});\
Export.table.toDrive(\{\
  collection: training4,\
  description:'globalvalpts4_withpredictors',\
  fileFormat: 'csv'\
\});\
\
Export.table.toDrive(\{\
    collection: validation,\
  description:'globalvalpts5_withpredictors',\
  fileFormat: 'CSV'\
\});\
\
\
