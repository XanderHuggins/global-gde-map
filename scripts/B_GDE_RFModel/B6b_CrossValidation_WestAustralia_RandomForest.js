...
\f0\fs24 \cf0 ////////////////////////////////////////////////////////////////////////////////////////////////////\
// Title: 8_CrossValidation_WestAustralia_RandomForest\
// Authors: Christine Albano and Melissa M. Rohde\
// Description: Cross validation test for West Australia \
...
\
\
// Load training outputs from "6_CrossValidation_WestAustralia_TrainingData" script\
...
\
\
// Load validation outputs from "6_CrossValidation_WestAustralia_TrainingData" script\
...
\
\
// Step 3.2. Extract Western Australia for cross validation\
\
// Load asset from "6_CrossValidation_WestAustralia_TrainingData" script\
var trainingpoints = ee.FeatureCollection('projects/ee-global-gde-map/assets/CrossValidation/trainingPts_noWestAus')\
\
\
// Western Australia data for cross validation\
var CrossVal_WestAus = ee.FeatureCollection('projects/ee-global-gde-map/assets/CrossValidation/trainingPts_WestAus')\
print(CrossVal_WestAus,'CrossVal_WestAus')\
\
///////////////////////////////////////\
// Step 4. Build Random Forest Model //\
///////////////////////////////////////\
\
// Step 4.1. Train the Classifier using tuned hyperparameters(output from "7_CrossValidation_WestAustralia_HyperparameterTuning" script)\
...
\
///////////////////////////////////////////\
// Step 6. Sample Western Australia Data //\
///////////////////////////////////////////\
\
var CrossVal_WestAus = classification.sampleRegions(\{\
    collection: CrossVal_WestAus,\
    scale: 30,\
    tileScale: 16\
  \});\
\
