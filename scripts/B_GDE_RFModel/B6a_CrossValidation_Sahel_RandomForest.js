...
\f0\fs24 \cf0 ////////////////////////////////////////////////////////////////////////////////////////////////////\
// Title: 8_CrossValidation_Sahel_RandomForest\
// Authors: Christine Albano and Melissa M. Rohde\
// Description: Random Forest model to map global groundwater-dependent ecosystems - \
// Cross Validation with Sahel data (Source: The World Bank)\
...
///////////////////////////////////////////////\
\
// Step 3.1. Load Training and Validation data\
\
// Load asset from "3_GDE_TrainingData" script\
var trainingpoints = ee.FeatureCollection('projects/ee-global-gde-map/assets/TrainingData/trainingPts');\
\
// Load training outputs from "3_GDE_TrainingData" script\
var training1 = ee.FeatureCollection('projects/ee-global-gde-map/assets/TrainingData/trainingpts1_withpredictors');\
var training2 = ee.FeatureCollection('projects/ee-global-gde-map/assets/TrainingData/trainingpts2_withpredictors');\
var training3 = ee.FeatureCollection('projects/ee-global-gde-map/assets/TrainingData/trainingpts3_withpredictors');\
var training4 = ee.FeatureCollection('projects/ee-global-gde-map/assets/TrainingData/trainingpts4_withpredictors');\
var training5 = ee.FeatureCollection('projects/ee-global-gde-map/assets/TrainingData/trainingpts5_withpredictors');\
var training6 = ee.FeatureCollection('projects/ee-global-gde-map/assets/TrainingData/trainingpts6_withpredictors');\
var training7 = ee.FeatureCollection('projects/ee-global-gde-map/assets/TrainingData/trainingpts7_withpredictors');\
var training8 = ee.FeatureCollection('projects/ee-global-gde-map/assets/TrainingData/trainingpts8_withpredictors');\
\
//Merge Training Data\
...
print(training.size(),'training size') // Check training point size\
\
\
// Load validation outputs from "3_GDE_TrainingData" script\
var validation1 = ee.FeatureCollection('projects/ee-global-gde-map/assets/TrainingData/validationpts1_withpredictors');\
var validation2 = ee.FeatureCollection('projects/ee-global-gde-map/assets/TrainingData/validationpts2_withpredictors');\
var validation = validation1.merge(validation2);\
print(validation.size(),'validation size') // Check validation point size\
\
///////////////////////////////////////\
// Step 4. Build Random Forest Model //\
///////////////////////////////////////\
\
// Step 4.1. Train the Classifier using tuned hyperparameters from "4_HyperparameterTuning"\
...
.train(training, "class", (["ETaP","CTI","lst_tpi5400","msavi","msavi_cv","ndvi", "ndvi_cv","ndwi_leaf","ndwi_leaf_cv","ndwi_water","ndwi_water_cv"]))\
//print(classifier,'classifier')\
\
\
var classification = predictorimage.classify(classifier);\
//print(classification, 'classification')\
\
// Step 4.2. Visualize the Classifier\
Map.addLayer(classification,\{min: 1,max: 2,palette:['green','white']\}, 'classification');\
          \
\
// Step 4.3. Test Model Accuracy\
var confMat = classifier.confusionMatrix();\
print('accuracy', confMat.accuracy());\
print('accuracy error matrix: ', confMat);\
\
// Step 4.4. Validate the model\
...
\
///////////////////////////////////////////\
// Step 5. Determine Variable Importance //\
///////////////////////////////////////////\
...
\
///////////////////////////////////////////\
// Step 6. Sample Sahel Data //\
///////////////////////////////////////////\
\
// Load output from "6_CrossValidation_Sahel_TrainingData" script\
\
var trainingPts_Sahel_GDE = ee.FeatureCollection('projects/ee-global-gde-map/assets/CrossValidation/SahelGDEpts');\
print('trainingPts_Sahel_GDE',trainingPts_Sahel_GDE.limit(10))\
print('trainingPts_Sahel_GDE Size',trainingPts_Sahel_GDE.size())\
\
var trainingPts_Sahel_nonGDE = ee.FeatureCollection('projects/ee-global-gde-map/assets/CrossValidation/SahelNonGDEpts');\
print('trainingPts_Sahel_nonGDE',trainingPts_Sahel_nonGDE.limit(10))\
print('trainingPts_Sahel_nonGDE Size',trainingPts_Sahel_nonGDE.size())\
\
\
var Sahel_GDE_Sample = classification.sampleRegions(\{\
    collection: trainingPts_Sahel_GDE,\
    scale: 30,\
    tileScale: 16\
  \});\
  \
var Sahel_nonGDE_Sample = classification.sampleRegions(\{\
    collection: trainingPts_Sahel_nonGDE,\
    scale: 30,\
    tileScale: 16\
  \});\
\
Export.table.toDrive(\{\
  collection: Sahel_GDE_Sample,\
  description:'Sahel_GDE_Sample',\
  fileFormat: 'csv'\
\});\
\
Export.table.toDrive(\{\
  collection: Sahel_nonGDE_Sample,\
  description:'Sahel_nonGDE_Sample',\
  fileFormat: 'csv'\
\});\
\
}