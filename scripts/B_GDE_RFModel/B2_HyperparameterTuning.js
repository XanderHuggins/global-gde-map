...
\f0\fs24 \cf0 ////////////////////////////////////////////////////////////////////////////////////////////////////\
// Title: Hyperparameter tuning for all training data used in Global GDE Model\
// Authors: Melissa M. Rohde\
// Description: Tune parameters in random forest model to retrieve optimal parameters to achieve highest accuracy\
...
// --- Number of Trees --- //\
// Tune the numberOfTrees parameter.\
var numTreesList = ee.List.sequence(90, 130, 10);\
\
var accuracies_trees = numTreesList.map(function(t) \{\
  var classifier = ee.Classifier.smileRandomForest(\{\
    numberOfTrees:t\})\
